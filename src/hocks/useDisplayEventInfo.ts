import {displayAndEventInfoInitState,displayAndEventInfoReducer,EventInfoActionType} from "reducers/DisplayAndEventInfo"
...
const actionList:SetEventInfo[] = [
    {
        url:"getNotRes",action:"insertNotReseds"
    },
    {
        url:"getResed",action:"insertReseds"
    },
    {
        url:"getEvent",action:"insertAttendEvents"
    }
]
...
export const useDisplayEventInfo = () => {
    ...
    const [displayAndEventInfo,displayAndEventInfoDispatch] = useReducer(displayAndEventInfoReducer,displayAndEventInfoInitState)
