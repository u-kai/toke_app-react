  ...
  return (
    ...
    >
       <ListItem button onClick={handleClickForNotRes}>
        ...
        <SimpleBadge
        color="secondary"
        badgeContent={notResMailsInfo.length}
        ></SimpleBadge>
        </ListItemIcon>
      ...
      <Collapse in={notResOpen} timeout="auto" unmountOnExit>
        <List component="div" disablePadding>
                ...
                notResMailsInfo.map((notResInfo,i)=>(
                    <ListItem key={`notResInfoItem${i}`} button className={classes.nested} id={notResInfo.id} onClick={onClickToDetail}>
        ...
        <List component="div" disablePadding>
          {
                resedMailsInfo.map((resedInfo,i)=>(
                    <ListItem key={`resedInfoItem${i}`} button className={classes.nested} id={resedInfo.id} onClick={onClickToDetail}>
