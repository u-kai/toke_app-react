...
const reducer = (
    ...
    switch (action.type) {
        ...
        case 'setState':
            return {
                ...state,
                isAttend: action.setState!.isAttend,
                responseMessage: action.setState!.responseMessage,
                isPush: {
...
export const ResponseInfoProvider: VFC<ChildrenProps> = (props) => {
    ...
    return (
        <ResponseInfoContext.Provider value={{ responseInfo, responseInfoDispatch }}>
            {children}
