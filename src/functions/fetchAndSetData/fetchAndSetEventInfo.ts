...
const actionList:SetEventInfo[] = [
    ...
    {
        url:"getEvent",action:"selectAttendEvent"
    }
]
const dateChecker = new DateChecker()
export const fetchAndSetEventInfo = (setEventInfo:SetEventInfo,userId:string,dispatch: React.Dispatch<{
...
export const fetchAndSetAllEvent = (userId:string,dispatch: React.Dispatch<{
    type: EventInfoActionType;
    id?: string | undefined;
    info?: ScheduleInfoResults | undefined;
}>) => {
