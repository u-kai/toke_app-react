...
CREATE TABLE attendance_requests (attendance_request_id Int   ,purpose varchar(1000)   ,date Timestamp DEFAULT CURRENT_TIMESTAMP  ,location varchar(1000)   ,start_date Timestamp DEFAULT CURRENT_TIMESTAMP  ,end_date Timestamp DEFAULT CURRENT_TIMESTAMP  ,organizer_id Int   ,describes varchar(1000)   ,bring varchar(1000)   ,organizer_name varchar(1000)    , PRIMARY KEY (attendance_request_id))
CREATE TABLE event_participants (participant_id Int   ,attendance_request_id Int    , PRIMARY KEY (attendance_request_id))
